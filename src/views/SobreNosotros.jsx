import { SecondaryText, TertiaryText, BodyText, MiniText } from "../components/Typography";
import { logos } from "../assets/logos";
import calidadIcon from "../assets/icons/calidad.webp";
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div>
          ...
          <div className="mt-6 flex justify-center">
            <img src={calidadIcon} alt="Calidad" className="w-48 h-auto" />
          </div>
        </div>

        {/* Descarga nuestro Brochure */}
        <div className="bg-foreground p-8 rounded-md text-center shadow-sm">
